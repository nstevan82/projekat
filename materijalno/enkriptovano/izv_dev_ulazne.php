...
<div class="box">
<?php
		$Vei0ij40kkwq=$Vkb4v4hyhajp->query("SELECT * FROM rac_dev_dobavljaci WHERE aktivan=1");
...
ORDER BY datum_ulaza,faktura_br,red	,dat_fak 	
	...
	<?php
			echo "<a href='izv_dev_ulazne1.php?dobavljac=$V24imcqdcpvk&godina=$V0qmlm2aq14j&odabrana_godina=$odabrana_godina&datum_do=$datum_do&datum_od=$datum_od' target='_blanc'><img src='../img/printer.png'></img></a>";
	}
	?>