...
<!-- forma za pretragu-->
	...
	$mysqli->dropdownajax($rezultat,"klasa","","id","'showHint()'");
	?>
	 </form>
	 </div>
	 <div class="box" id="response" style="max-width:800px;margin-left:10px;margin-right:10px">
	 </div>
...
$pass=$_POST['password'];
$jmbg=$_POST['jmbg'];
$rezultat=$mysqli->query("UPDATE adm_korisnici VALUES set nalog=$nalog, password=$pass,jmbg=$jmbg WHERE id='$id'");
}
