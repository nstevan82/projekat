...
<?php 
if (isset($_POST['skladista'])) $skladista1=$_POST['skladista'];
else
$skladista1=$skladista;
		$rezultat=$mysqli->query("SELECT * FROM mag_skladista WHERE aktivan=1");
		$mysqli->dropdown1($rezultat,'skladista',$skladista1,'id');
		?>
...
<?php
if (isset($_POST['trazi']) || isset($_GET['id']) || isset($_POST['unesi']) ||  isset($_GET['strana']) ||isset($_POST['izmeni'])){
if (isset($_POST['trazi'])) {$_SESSION['skladista']=$_POST['skladista'];
							}
