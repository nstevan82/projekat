...
<input type=hidden name=str value='izv_dev_izvodi'>
...
$rezultat= $mysqli->query("SELECT *,rac_dev_kupci.naziv AS n_kupca,rac_dobavljaci.naziv AS n_dobavljaca
FROM rac_dev_izvodi 
...
WHERE rac_dev_izvodi.aktivan=1 
AND dat_izv='$datum' 
AND banka='$banka'
