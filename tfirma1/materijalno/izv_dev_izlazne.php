...
ORDER BY dat_ulaza,izlazi.red,izlazi.red_izlaz,izlazi.dat_fak
	 ...
	 ");?>
		...
		<?php
				...
				if ($dat_fak=='01.01.1970' && $row['dat_fak']<=$datum_do && $row['dat_fak']>=$datum_od) $dat_fak='';/*izmena */
		...
		elseif ($row['n_usluge']=="sum_platio"&& $row['dat_fak']<=$datum_do)  {
				/*izmena */
	...
	<?php
		echo "<a href='izv_dev_izlazne1.php?kupac=$kupac&godina=$akt_godina&datum_do=$datum_do&datum_od=$datum_od' target='_blanc'><img src='../img/printer.png'></img></a>";
	}
	?>