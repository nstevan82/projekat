...
<div class="box">
		...
		<input type=text name=blagajna placeholder='rb.blagajne'>
...
?>
	...
	<?php
			echo "<a href='izv_blagajna1.php?datum=$datum&blagajna=$blagajna' target='_blanc'><img src='../img/printer.png'></img></a>";
	}
	?>