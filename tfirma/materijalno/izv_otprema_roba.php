...
<form method=post action='default.php'>
		...
		$mysqli->dropdown1($rezultat,'vrstarobe','',id);
		?>
		&nbsp Sva roba<input type=checkbox name=svi>
		&nbsp Godina<input type='text' name=godina value='<?php echo $akt_godina?>'>
		<input type='hidden' name=str value='izv_otprema_roba'>
...
<?php echo "<b><u>IZVESTAJ OTPREMLJENE ROBE STAMPAN DANA: ".date('d.m.Y')." ZA $godina. GODINU.</u></b><br><br>"; ?>
			<table class="lista" style="diplay:block;width:100%">
				<tr><th>Rb</th><th>Vrsta robe</th><th>Tezina</th></tr>
				<?php
				$i=1;
				$suma=0;
				...
				echo "<tr class='lista'><td colspan=2>UKUPNO:</td><td>".number_format($suma, 2, ',', '.')."</td></tr>";				
				echo "</table>";
			
if ($svi==0) echo "<a href='izv_otprema_roba1.php?godina=$godina&vrstarobe=$vrstarobe' target='_blanc'><img src='../img/printer.png'></img></a>";
else
echo "<a href='izv_otprema_roba1.php?godina=$godina&vrstarobe=$vrstarobe&svi=1' target='_blanc'><img src='../img/printer.png'></img></a>";
echo "</div>";
